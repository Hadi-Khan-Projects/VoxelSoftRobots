...
if __name__ == "__main__":
    ...
    GENERATION_TO_RUN = 6  # rerun generation
    INDIVIDUAL_TO_RUN = 1  # individual index 3 from that generation

    # CRUCUALLY: Use same control timestep and gear
    ...
    if VoxelRobot is None:
        ...
        try:
            ...
            vsr_instance = VoxelRobot(10, 10, 10, gear=GEAR)  # Use appropriate dims
